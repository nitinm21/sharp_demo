    ...
    >
      ...
      >
        {colorOptions.map((option, index) => {
          const isSelected = answers.colorPreference === option.value;
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0">
                <Image
                  src="/images/landscape-vivid.jpg"
                  alt={option.label}
                  fill
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: isSelected
                    ? "0 0 30px rgba(94, 179, 228, 0.4), inset 0 0 30px rgba(94, 179, 228, 0.1)"
                    : "none",
                }}
              />
              ...
              {isSelected && (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: "0 2px 10px rgba(94, 179, 228, 0.5)",
                  }}
                >
